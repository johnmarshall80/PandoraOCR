/**
 *  @file   PandoraOCR/include/VisualMonitoringAlgorithm.h
 * 
 *  @brief  Header file for the visual monitoring algorithm class
 * 
 *  $Log: $
 */
#ifndef OCR_VISUAL_MONITORING_ALGORITHM_H
#define OCR_VISUAL_MONITORING_ALGORITHM_H 1
...
private:
    ...
    float                   m_scalingFactor;            ///< TEve works with [cm], Pandora usually works with [mm] (but OCR went with cm too)
...
#endif // #ifndef OCR_VISUAL_MONITORING_ALGORITHM_H
